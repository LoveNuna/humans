...
import (
	...
	humanmodule "human/x/human"
	humanmodulekeeper "human/x/human/keeper"
	humanmoduletypes "human/x/human/types"
...
type App struct {
	*baseapp.BaseApp
	...
	HumanKeeper humanmodulekeeper.Keeper
...
func New(
	...
	app.HumanKeeper = *humanmodulekeeper.NewKeeper(
		appCodec,
		keys[humanmoduletypes.StoreKey],
		keys[humanmoduletypes.MemStoreKey],
		app.GetSubspace(humanmoduletypes.ModuleName),
	)
	humanModule := humanmodule.NewAppModule(appCodec, app.HumanKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(humanmoduletypes.ModuleName)
