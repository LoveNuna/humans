...
import HumanHumanHmint from './human/human.hmint'
import HumanHumanHuman from './human/human.human'
...
export default { 
  ...
  HumanHumanHmint: load(HumanHumanHmint, 'human.hmint'),
  HumanHumanHuman: load(HumanHumanHuman, 'human.human'),
