...
export const PoolBalanap = {
  encode(message: PoolBalanap, writer: Writer = Writer.create()): Writer {
    if (message.index !== "") {
      writer.uint32(10).string(message.index);
    }
    if (message.transactionData !== "") {
      writer.uint32(18).string(message.transactionData);
    }
    if (message.originChain !== "") {
      writer.uint32(26).string(message.originChain);
    }
    if (message.originAddress !== "") {
      writer.uint32(34).string(message.originAddress);
    }
    ...
    if (message.confirmedBlockHash !== "") {
      writer.uint32(90).string(message.confirmedBlockHash);
    }
    if (message.signedKey !== "") {
      writer.uint32(98).string(message.signedKey);
    }
    if (message.fee !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): PoolBalanap {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...basePoolBalanap } as PoolBalanap;
  ...
  fromJSON(object: any): PoolBalanap {
    const message = { ...basePoolBalanap } as PoolBalanap;
  ...
  toJSON(message: PoolBalanap): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<PoolBalanap>): PoolBalanap {
    const message = { ...basePoolBalanap } as PoolBalanap;
    if (object.index !== undefined && object.index !== null) {
    ...
    if (
      ...
      message.transactionData = object.transactionData;
    } else {
      message.transactionData = "";
    }
    if (object.originChain !== undefined && object.originChain !== null) {
