...
export interface QueryGetPoolBalanapRequest {
  index: string;
}

export interface QueryGetPoolBalanapResponse {
  poolBalanap: PoolBalanap | undefined;
}

export interface QueryAllPoolBalanapRequest {
  pagination: PageRequest | undefined;
}

export interface QueryAllPoolBalanapResponse {
  poolBalanap: PoolBalanap[];
  pagination: PageResponse | undefined;
}
...
const baseQueryGetPoolBalanapRequest: object = { index: "" };

export const QueryGetPoolBalanapRequest = {
  encode(
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetPoolBalanapRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPoolBalanapRequest,
    } as QueryGetPoolBalanapRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetPoolBalanapRequest {
    const message = {
      ...baseQueryGetPoolBalanapRequest,
    } as QueryGetPoolBalanapRequest;
    if (object.index !== undefined && object.index !== null) {
  ...
  toJSON(message: QueryGetPoolBalanapRequest): unknown {
    const obj: any = {};
    message.index !== undefined && (obj.index = message.index);
    return obj;
  },
  ...
  fromPartial(
    object: DeepPartial<QueryGetPoolBalanapRequest>
  ): QueryGetPoolBalanapRequest {
    const message = {
      ...baseQueryGetPoolBalanapRequest,
    } as QueryGetPoolBalanapRequest;
...
const baseQueryGetPoolBalanapResponse: object = {};

export const QueryGetPoolBalanapResponse = {
  encode(
    message: QueryGetPoolBalanapResponse,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.poolBalanap !== undefined) {
      PoolBalanap.encode(
        message.poolBalanap,
        writer.uint32(10).fork()
      ).ldelim();
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetPoolBalanapResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPoolBalanapResponse,
    } as QueryGetPoolBalanapResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.poolBalanap = PoolBalanap.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): QueryGetPoolBalanapResponse {
    const message = {
      ...baseQueryGetPoolBalanapResponse,
    } as QueryGetPoolBalanapResponse;
    if (object.poolBalanap !== undefined && object.poolBalanap !== null) {
      message.poolBalanap = PoolBalanap.fromJSON(object.poolBalanap);
    } else {
      message.poolBalanap = undefined;
    }
    return message;
  },

  toJSON(message: QueryGetPoolBalanapResponse): unknown {
    const obj: any = {};
    message.poolBalanap !== undefined &&
      (obj.poolBalanap = message.poolBalanap
        ? PoolBalanap.toJSON(message.poolBalanap)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetPoolBalanapResponse>
  ): QueryGetPoolBalanapResponse {
    const message = {
      ...baseQueryGetPoolBalanapResponse,
    } as QueryGetPoolBalanapResponse;
    if (object.poolBalanap !== undefined && object.poolBalanap !== null) {
      message.poolBalanap = PoolBalanap.fromPartial(object.poolBalanap);
    } else {
      message.poolBalanap = undefined;
    }
    return message;
...
const baseQueryAllPoolBalanapRequest: object = {};

export const QueryAllPoolBalanapRequest = {
  encode(
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPoolBalanapRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPoolBalanapRequest,
    } as QueryAllPoolBalanapRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAllPoolBalanapRequest {
    const message = {
      ...baseQueryAllPoolBalanapRequest,
    } as QueryAllPoolBalanapRequest;
    if (object.pagination !== undefined && object.pagination !== null) {
  ...
  toJSON(message: QueryAllPoolBalanapRequest): unknown {
    const obj: any = {};
    message.pagination !== undefined &&
      (obj.pagination = message.pagination
        ? PageRequest.toJSON(message.pagination)
  ...
  fromPartial(
    object: DeepPartial<QueryAllPoolBalanapRequest>
  ): QueryAllPoolBalanapRequest {
    const message = {
      ...baseQueryAllPoolBalanapRequest,
    } as QueryAllPoolBalanapRequest;
...
const baseQueryAllPoolBalanapResponse: object = {};

export const QueryAllPoolBalanapResponse = {
  encode(
    message: QueryAllPoolBalanapResponse,
    writer: Writer = Writer.create()
  ): Writer {
    for (const v of message.poolBalanap) {
      PoolBalanap.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(
        message.pagination,
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPoolBalanapResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPoolBalanapResponse,
    } as QueryAllPoolBalanapResponse;
    message.poolBalanap = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.poolBalanap.push(PoolBalanap.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = PageResponse.decode(reader, reader.uint32());
          break;
  ...
  fromJSON(object: any): QueryAllPoolBalanapResponse {
    const message = {
      ...baseQueryAllPoolBalanapResponse,
    } as QueryAllPoolBalanapResponse;
    message.poolBalanap = [];
    if (object.poolBalanap !== undefined && object.poolBalanap !== null) {
      for (const e of object.poolBalanap) {
        message.poolBalanap.push(PoolBalanap.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromJSON(object.pagination);
  ...
  toJSON(message: QueryAllPoolBalanapResponse): unknown {
    const obj: any = {};
    if (message.poolBalanap) {
      obj.poolBalanap = message.poolBalanap.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllPoolBalanapResponse>
  ): QueryAllPoolBalanapResponse {
    const message = {
      ...baseQueryAllPoolBalanapResponse,
    } as QueryAllPoolBalanapResponse;
    ...
    if (object.poolBalanap !== undefined && object.poolBalanap !== null) {
      for (const e of object.poolBalanap) {
        message.poolBalanap.push(PoolBalanap.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromPartial(object.pagination);
...
export interface Query {
  ...
  PoolBalanap(
    request: QueryGetPoolBalanapRequest
  ): Promise<QueryGetPoolBalanapResponse>;
  /** Queries a list of PoolBalanap items. */
  PoolBalanapAll(
    request: QueryAllPoolBalanapRequest
  ): Promise<QueryAllPoolBalanapResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("human.human.Query", "Params", data);
  ...
  FeeBalance(
    ...
    const promise = this.rpc.request("human.human.Query", "FeeBalance", data);
  ...
  ObserveVote(
    ...
    const promise = this.rpc.request("human.human.Query", "ObserveVote", data);
    return promise.then((data) =>
  ...
  PoolBalance(
    ...
    const promise = this.rpc.request("human.human.Query", "PoolBalance", data);
    return promise.then((data) =>
  ...
  PoolBalanap(
    ...
    const data = QueryGetPoolBalanapRequest.encode(request).finish();
    const promise = this.rpc.request("human.human.Query", "PoolBalanap", data);
    return promise.then((data) =>
      QueryGetPoolBalanapResponse.decode(new Reader(data))
    );
  }
  ...
  PoolBalanapAll(
    ...
    const data = QueryAllPoolBalanapRequest.encode(request).finish();
    const promise = this.rpc.request(
      "human.human.Query",
      "PoolBalanapAll",
      data
    ...
    return promise.then((data) =>
      QueryAllPoolBalanapResponse.decode(new Reader(data))
    );
  }
}
